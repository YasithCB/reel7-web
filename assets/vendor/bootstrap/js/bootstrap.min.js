...
!(function (t, e) {
  ...
  class Nt extends R {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding ? F.one(this._element, bt, () => this.cycle()) : this.cycle());
    }
    to(t) {
  ...
  class Ce extends W {
    ...
    dispose() {
      this._isAppended &&
        (F.off(this._element, we), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class Fi extends R {
    ...
    show() {
      ...
      const t = F.trigger(this._element, this.constructor.eventName("show")),
        e = (_(this._element) || this._element.ownerDocument.documentElement).contains(
          this._element
        );
    ...
    hide() {
      if (
        ...
        if (
          (this._getTipElement().classList.remove(Si), "ontouchstart" in document.documentElement)
        )
          for (const t of [].concat(...document.body.children)) F.off(t, "mouseover", g);
        ...
        if ("click" === e)
          ...
          (F.on(this._element, t, this._config.selector, (t) => {
            ...
            F.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              ((e._activeTrigger["focusout" === t.type ? Ni : Di] = e._element.contains(
                t.relatedTarget
              )),
                e._leave());
            }));
